...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a17y3nlrpkj0gu-ats.iot.ap-southeast-1.amazonaws.com --ca_file root-CA.crt --cert EnergyTracking.cert.pem --key EnergyTracking.private.key --client_id basicPubSub --topic sdk/test/python --count 0